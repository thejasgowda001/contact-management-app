...
const Contacts = () => {
    ...
    return (
        <div className="justify-center pt-16 text-gray-50   p-4  w-full ">
            <div className="m-4">
                <button className="rounded-full bg-red-600 p-2 text-2xl">
            ...
            {AllContacts.length == 0 && <div className=" m-auto w-fit p-4 align-middle text-red-500 justify-center">
                ...
                <h1 className="text-3xl">No Contact Found Please add contact from <br /> Create Contact by clicking above button</h1>
            </div>}
